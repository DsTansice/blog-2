...
hexo.extend.filter.register('after_generate', function (locals) {
  ...
  //cdn资源声明
    //样式资源
  const css_text = data.mobile ? `<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/EmptyDreams/resources/code/ajax/animate_4-1-1.min.css" media="print" onload="this.media='all'">` : `<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/EmptyDreams/resources/code/ajax/animate_4-1-1.min.css" media="print" onload="this.media='screen'">`;
    //脚本资源
