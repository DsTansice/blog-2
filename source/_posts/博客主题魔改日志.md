...
tags:
  ...
  - 魔改
description: >-
  这次想要更新一下主题的版本，但是发现自己完全不记得自己修改过哪些文件了，所以只能从头重新魔改一遍。有了前车之鉴，我决定将所有魔改记录全部记录在这篇博文中。
abbrlink: 3bc89eb
...
{% link Butterfly 主题的 PWA 实现方案 by Akilar, https://akilar.top/posts/8f31c3d0/, https://cdn.jsdelivr.net/npm/akilar-candyassets/image/siteicon/favicon.ico %}
